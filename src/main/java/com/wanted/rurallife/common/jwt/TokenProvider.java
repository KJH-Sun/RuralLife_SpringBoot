...
import com.wanted.rurallife.exception.user.UnauthorizedException;
...
public class TokenProvider implements InitializingBean {
     ...
     */
    public TokenDto createToken(String tel,
        String authorities) {

        long now = (new Date()).getTime();

        UserBase user = userRepository.findByTel(tel) // princial.toSTring()
    ...
    public Authentication getAuthentication(String token) {
        ...
        return new UsernamePasswordAuthenticationToken(claims.get("tel"), null, authorities);
    }
